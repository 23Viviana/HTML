...
// Seccion de validacion de nombre
    ...
    // Seccion de validación de doc identidad
    if (documentoval ==="") {
...
// Seccion de validación de password
    if (password1val ===""){
        ...
        ocErrorform(password1,"passwor debe tener minimo 8 caracteres, una letra mayuscula, una letra minuscula, un numero y un caracter especial");
        errorf=1;
    }
    else{
...
// Seccion de validación de ingreso exitoso sin errores
    ...
    //La contraseña debe tener al entre 8 y 16 caracteres, al menos un dígito, al menos una minúscula, al menos una mayúscula y al menos un caracter especial.
...
//Mostrar contraseña en dos controles respectivos
